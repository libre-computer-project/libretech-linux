			      ...
			      struct bio *bio)
{
	...
	while (working_bytes > 0) {
		...
		/*
		 * Make sure our new page is covered by this working buffer
		 */
		if (total_out <= start_byte)
			return 1;

		/*
		 * The next page in the biovec might not be adjacent to the
		 * last page, but it might still be found inside this working
